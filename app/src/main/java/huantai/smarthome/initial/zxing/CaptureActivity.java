 ...
 */
package huantai.smarthome.initial.zxing;
...
import huantai.smarthome.initial.zxing.camera.CameraManager;
import huantai.smarthome.initial.zxing.decoding.DecodeThread;
import huantai.smarthome.initial.zxing.utils.CaptureActivityHandler;
import huantai.smarthome.initial.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends GosBaseActivity implements SurfaceHolder.Callback {
          ...
          private String code;
          private String uid,mac, productKey, productSecret;
          ...
          private enum handler_key {
                    ...
                    START_BIND,SHARING,SUCCESS,FAILED,FAILED_QRC,SHARING_BIND
          }
                    ...
                    if (text.contains("product_key=") && text.contains("did=") && text.contains("passcode=")) {
                         ...
                         && text.contains("productSecret"))) {
                              ...
                              if((type.equals("bang"))&&(uid!=null)&&(token!=null))
                                        mHandler.sendEmptyMessage(handler_key.SHARING_BIND.ordinal());
                              else
