...
public class AirMateActivity extends Activity {
    ...
    private ImageView iv_aircon_back;
...
//    }
    ...
    private void initView() {
        ...
        iv_aircon_back = (ImageView) findViewById(R.id.iv_aircon_back);
    ...
    private void initEvent() {
        ...
        iv_aircon_back.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AirMateActivity.this, AirConBrandActivity.class);
