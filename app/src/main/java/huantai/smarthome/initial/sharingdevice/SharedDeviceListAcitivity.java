...
import huantai.smarthome.initial.CommonModule.NoScrollViewPager;
import huantai.smarthome.initial.R;
import huantai.smarthome.initial.sharingdevice.ViewPagerIndicator.PageChangeListener;
import huantai.smarthome.initial.sharingdevice.mySharedFragment2.myadapter;
...
public class SharedDeviceListAcitivity extends GosBaseActivity {
	...
	private void initView() {
		...
		huantai.smarthome.initial.sharingdevice.ViewPagerIndicator indicator = (ViewPagerIndicator) findViewById(
				R.id.vpi_indicator);
